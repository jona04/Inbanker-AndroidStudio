...
public class EnviaEmailTrans extends AsyncTask<String,String,String> {

    Transacao transacao;
    String email_user1;
    String email_user2;

    public EnviaEmailTrans(Transacao transacao,String email_user1,String email_user2){
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            final String url = host+"appinbanker/email/enviaEmail/transacao/"+email_user1+"/"+email_user2;
