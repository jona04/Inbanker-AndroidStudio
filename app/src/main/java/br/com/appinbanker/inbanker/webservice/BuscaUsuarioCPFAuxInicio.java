...
public class BuscaUsuarioCPFAuxInicio extends AsyncTask<String,String,Usuario> {
    ...
    public BuscaUsuarioCPFAuxInicio(String cpf, Context context, WebServiceReturnUsuario ti){
        this.cpf = cpf;
    ...
    protected void onPostExecute(Usuario result) {
        ...
        ti.retornoUsuarioWebServiceAuxInicioToken(result);
    }
