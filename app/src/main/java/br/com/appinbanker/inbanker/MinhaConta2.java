...
public class MinhaConta2 extends AppCompatActivity implements WebServiceReturnUsuario,WebServiceReturnString {
    ...
    public void dialog_redefinir_senha(){
        dialog = new Dialog(MinhaConta2.this,R.style.AppThemeDialog);
    ...
    public void dialog_atualiza_dados(){
        ...
        btn_atualiza_usuario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BancoControllerUsuario crud = new BancoControllerUsuario(MinhaConta2.this);
                Cursor cursor = crud.carregaDados();
                String cpf = cursor.getString(cursor.getColumnIndexOrThrow(CriandoBanco.CPF));
