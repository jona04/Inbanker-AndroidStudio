...
public class BuscaUsuarioCPFAux extends AsyncTask<String,String,Usuario> {
    ...
    public BuscaUsuarioCPFAux(String cpf, Context context, WebServiceReturnUsuario ti){
        this.cpf = cpf;
    ...
    protected void onPostExecute(Usuario result) {
        ...
        Log.w("webservice", "resesult busca usuario cpf aux= "+result);

        ti.retornoUsuarioWebServiceAux(result);
    }
