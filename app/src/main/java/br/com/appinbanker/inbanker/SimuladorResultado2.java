...
public class SimuladorResultado2 extends AppCompatActivity implements WebServiceReturnStringHora,WebServiceReturnUsuarioFace {
    ...
    public void mensagemIntent(String titulo,String corpo,String botao_positivo,String botao_neutro)
    {
        ...
        mensagem.setPositiveButton(botao_positivo,new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Intent it = new Intent(SimuladorResultado2.this,TelaCadastroSimulador.class);
                startActivity(it);
                //para encerrar a activity atual e todos os parent
                //finishAffinity();
            }
