...
public class SimuladorResultado2 extends AppCompatActivity implements WebServiceReturnStringHora,WebServiceReturnString,WebServiceReturnUsuarioFace {
        ...
        btn_fazer_pedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cpf.equals("")){
                    ...
                    // custom dialog
                    dialog_cadastro = new Dialog(SimuladorResultado2.this,R.style.AppThemeDialog);
                    ...
                    btn_cadastrar.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            if(!CheckConection.temConexao(SimuladorResultado2.this)){
                    ...
                    // custom dialog
                    final Dialog dialog = new Dialog(SimuladorResultado2.this,R.style.AppThemeDialog);
    ...
    public void buscaUsuarioFace() {
        new BuscaUsuarioFace(id, SimuladorResultado2.this, this).execute();
    }
    ...
    public void clickCadastrar(){
        ...
        if (et_senha_cadastro.getText().toString().equals(et_senha_novamente_cadastro.getText().toString())) {
            ...
            if(campos_ok) {
                ...
                //new VerificaUsuarioCadastro(et_email_cadastro.getText().toString(), et_cpf_cadastro.getText().toString(), SimuladorResultado2.this).execute();
            }
    ...
    public void retornoObterHora(String hoje){
        ...
        if(hoje!=null) {
            if (hoje.equals("error")) {
                ...
                //new AddTransacao(trans, SimuladorResultado2.this).execute();
    ...
    public void mensagemIntent(String titulo,String corpo,String botao)
    {
        ...
        mensagem.setPositiveButton(botao,new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Intent it = new Intent(SimuladorResultado2.this,NavigationDrawerActivity.class);
                startActivity(it);
